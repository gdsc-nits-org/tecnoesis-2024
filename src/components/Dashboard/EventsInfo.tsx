...
const EventTable = ({ index, opened, item }: EventTableProps) => {
  return (
    <>
      {opened && (
        <table key={index} className="relative right-0 mt-4 w-full table-auto text-xs sm:right-0 sm:mt-0 sm:text-sm">
          <thead>
            <tr className="border-b border-gray-700">
              <th className="px-2 py-1 text-left font-semibold text-gray-300 sm:px-3 sm:py-2">Name</th>
              <th className="px-2 py-1 text-left font-semibold text-gray-300 sm:px-3 sm:py-2">Username</th>
              <th className="px-2 py-1 text-left font-semibold text-gray-300 sm:px-3 sm:py-2">Status</th>
            </tr>
          </thead>
          <tbody>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="flex w-[100%] flex-col">
              ...
              <EventTable opened={opened[index]!} index={index} item={item} />
            </div>
          </div>
        ))}
      </div>
