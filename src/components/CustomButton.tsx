...
const CustomButton: React.FC<CustomButtonProps> = ({ text,width}) => {
  return (
    <div className={`customBtn relative overflow-hidden flex items-center w-[${width}] justify-center text-white text-xl hover:text-2xl cursor-pointer bg-[transparent] p-5 hover:bg-[#2F629C] duration-500`}>
