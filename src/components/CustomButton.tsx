...
const CustomButton: React.FC<CustomButtonProps> = ({ text }) => {
  return (
    <div className='customBtn relative overflow-hidden p-7 flex items-center justify-center text-white text-xl hover:text-2xl cursor-pointer bg-[transparent] hover:bg-[#2F629C] duration-500'>
